  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
      ...
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0 space-y-4'>
        <SocialIcon link='www.linkedin.com/in/sahil-shinde-a37090259' icon={<FaLinkedin size={30} />} text='Linkedin' />
        <SocialIcon link='https://github.com/shindesahil321' icon={<FaGithub size={30} />} text='Github' />
